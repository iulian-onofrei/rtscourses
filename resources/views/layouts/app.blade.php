            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('courses') }}">{{ __('Cursuri') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('user') }}">{{ __('Profil') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link">{{ __('Contacte') }}</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        @foreach($available_locales as $locale_name => $available_locale)
                            @if($available_locale !== $current_locale)
                                <li class="nav-item">
                                    <a class="nav-link underline" href="lang/{{ $available_locale }}">{{ $locale_name }}</a>
                                </li>
                            @endif
                        @endforeach
                    </ul>
